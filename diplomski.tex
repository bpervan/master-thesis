...
\begin{algorithm}
	...
	\begin{algorithmic}
		...
		matrica ocjena korisnika gdje su retci predmeti, a stupci korisnici}
		\STATE{\textbf{Izlaz:} Predikcija $p$ ocjene korisnika $K$ za predmet $P$.}
		\STATE{$N^T := transpose(N);$}
...
\begin{figure}[htb]
	\centering
	\includegraphics[width=7cm]{images/collaborative/movielens.png}
	\caption{Primjer preporuke sustava \glqq MovieLens\grqq}
	\label{fig:movielens}
\end{figure}

Ovaj pristup je relativno efikasan i jednostavan za implementaciju, ali druge strane, računalno postaje vrlo zahtjevan ako se primjeni na velike baze podataka
