...
Suradničko filtriranje na razini predmet-predmet
\begin{equation}
...
\begin{enumerate}
  ...
  \item Izmjenični
  \item Miješani
  \item Kombinacija obilježja
  \item Kaskada
  \item Pojačavanje obilježja
  \item Meta razina
\end{enumerate}
\subsection{Moguća područja primjene}
\subsection{Preporučiteljski sustavi u sveprisutnom računarstvu}
