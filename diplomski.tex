...
\begin{algorithm}
	...
	\begin{algorithmic}
		...
		% karakteristike
		\FOR{$predmet \in PoljeKarakteristike$}
			\STATE{$userPolje := $}
		\ENDFOR
		
		%TREĆA FAZA ALGORITMA, izračunati IDF
		\FORALL{$w \in PojedinaKarakteristika$}
			\STATE{$test$}
		\ENDFOR
